...
import com.alma.telekocsi.init.LoadDataRomain;
...
public class MainUI extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		btLoadDataRomain = (Button)findViewById(R.id.btMainLoadDataRomain);
		btLoadDataRomain.setOnClickListener(getOnClickListener());
	...
	public void loadDataRomain() {  
		LoadDataRomain loadDataRomain = new LoadDataRomain();
		loadDataRomain.load();
	}  
}